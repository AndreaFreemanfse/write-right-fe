...
function AnalysisLoading({ targetLanguage }) {
  const selectedWord = useMemo(() => {
    ...
    const availableWords =
      vocabulary[normalizedLanguage] || vocabulary.english;
    ...
    <main className="analysis-loading">
      <section className="analysis-loading__panel">
        ...
        <div className="vocabulary-card">
          <p className="vocabulary-card__label">
            Word of the Day
          </p>

          <p className="vocabulary-card__language">
            {displayLanguage}
          </p>
          ...
          <p className="vocabulary-card__meaning">
